...
describe('toHsl', () => {
  ...
  test('should return hsl color object from str', () => {
    expect(fn('black')).toEqual({
      h: 0,
      s: 0,
      l: 0
    });
    expect(fn('white')).toEqual({
      h: 0,
      s: 0,
      l: 100
    });
    expect(fn('red')).toEqual({
      h: 0,
      s: 100,
      l: 50
    });
    expect(fn('green')).toEqual({
      h: 120,
      s: 100,
      l: 25
    });
    expect(fn('blue')).toEqual({
      h: 240,
      s: 100,
      l: 50
    });
    expect(fn('cyan')).toEqual({
      h: 180,
      s: 100,
      l: 50
    });
    expect(fn('yellow')).toEqual({
      h: 60,
      s: 100,
      l: 50
    });
